...
internal class PeekabooGalleryRepositoryImpl(private val context: Context) :
    PeekabooGalleryRepository {
    ...
    override fun getPicturePagingSource(): PagingSource<Int, PeekabooMediaImage> {
        return PeekabooGalleryDataSource { limit, offset ->
            context.fetchPagePicture(
                limit,
                offset
            )
        }
