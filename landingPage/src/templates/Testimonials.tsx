  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-6 lg:py-16">
      ...
      <div class="mb-8 grid lg:mb-12 lg:grid-cols-2">
        <figure class="flex flex-col items-center justify-center border-b border-gray-200 bg-gray-50 p-8 text-center md:p-12 lg:border-r dark:border-gray-700 dark:bg-gray-800">
        ...
        <figure class="flex flex-col items-center justify-center border-b border-gray-200 bg-gray-50 p-8 text-center md:p-12 dark:border-gray-700 dark:bg-gray-800">
          <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
        ...
        <figure class="flex flex-col items-center justify-center border-b border-gray-200 bg-gray-50 p-8 text-center md:p-12 lg:border-b-0 lg:border-r dark:border-gray-700 dark:bg-gray-800">
          <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
        ...
        <figure class="flex flex-col items-center justify-center border-gray-200 bg-gray-50 p-8 text-center md:p-12 dark:border-gray-700 dark:bg-gray-800">
          <blockquote class="mx-auto mb-8 max-w-2xl text-gray-500 dark:text-gray-400">
            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
