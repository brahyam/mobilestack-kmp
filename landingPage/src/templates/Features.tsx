  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
      ...
      <div class="space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3">
        <div>
          <div class="mb-4 flex size-10 items-center justify-center rounded-full bg-primary-100 lg:size-12 dark:bg-primary-900">
            <svg
              class="size-5 text-primary-600 lg:size-6 dark:text-primary-300"
              fill="currentColor"
              viewBox="0 0 20 20"
